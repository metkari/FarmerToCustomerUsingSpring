    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#contact">CONTACT</a></li>
         <li><a href="/FarmerToCustomerUsingSpring/about">ABOOUT US</a></li>
         <li><a href="/FarmerToCustomerUsingSpring/login"> Login</a></li>
...
<tbody>       
<tr>
<td style="width: 25%">Sujit Shinde</td>
<td style="width: 25%">Nikhil Tiwalkar</td>
<td style="width: 25%">Dinesh Metkari</td>
<td style="width: 25%">Aditya Gupta</td>
<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
<td style="width: 254px">email: SujitShinde@gmail.com</td>
<td style="width: 639px">email: ntiwalkar@gmail.com</td>
<td>email: dineshmetkari001@gmail.com</td>
<td style="width: 25%">email: adityaGupta@gmail.com</td>
</tr>
